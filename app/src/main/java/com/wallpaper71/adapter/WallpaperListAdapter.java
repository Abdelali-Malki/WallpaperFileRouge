...
public class WallpaperListAdapter extends RecyclerView.Adapter<WallpaperListAdapter.WallpapersHolder> {

    public static List<WallpaperDataAll> wallpaperList;
    Context context;
    String from;

    public WallpaperListAdapter(List<WallpaperDataAll> wallpaperList, Context context, String from) {
    ...
    public WallpapersHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        WallpapersHolder mh = new WallpapersHolder(v);
    ...
    public void onBindViewHolder(WallpapersHolder holder, int position) {
        ...
        //Glide.with(context).load(productImageDir2+wallpaperList.get(position).getPhoto()+".webp").into(holder.wallpaperImg);
